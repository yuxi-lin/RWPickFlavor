...
echo 'commiting and pushing changes to git'
echo " "
git add .
git commit -m "updating and tagging pod to $major.$minor.$build"
...
echo " "
$(pod repo push --allow-warnings "$podSpecRepo" "$podspecFilename")
echo " "
echo 'Done'
echo " "
exit 0
